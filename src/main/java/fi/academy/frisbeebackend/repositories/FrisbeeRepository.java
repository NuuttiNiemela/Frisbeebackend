...
public interface FrisbeeRepository extends PagingAndSortingRepository<Frisbee, Integer> {
    ...
    Page<Frisbee> findAllByName(String name, Pageable sivutus);

    List<Frisbee> findById (@Param("haku") String haku);
    List<Frisbee> findAllById(Integer id, Pageable sivutus);

    List<Frisbee> findAllBySpeed(Double speed, Pageable sivutus);

    List<Frisbee> findAllByGlide(Integer glide, Pageable sivutus);

    List<Frisbee> findAllByTurn(Integer turn, Pageable sivutus);

    List<Frisbee> findAllByFade(Double fade, Pageable sivutus);
